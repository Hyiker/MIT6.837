...
int Matrix::Inverse(Matrix& m, float epsilon) const {
    ...
    float det =
        det4x4(a1, a2, a3, a4, b1, b2, b3, b4, c1, c2, c3, c4, d1, d2, d3, d4);
...
float Matrix::det4x4(float a1, float a2, float a3, float a4, float b1, float b2,
...
float Matrix::det3x3(float a1, float a2, float a3, float b1, float b2, float b3,
