...
task("raytracerx_scenes")
    ...
    on_run(function ()
        ...
        os.exec("xmake r raytracerx -input ".. assets .."/scene1.txt -size 400 400 -output ".. imgs .."/scene1.exr -shadows -jittered_samples 1024 -tent_filter 1.5 -bounces 2 -grid 40 40 40" .. flags)
